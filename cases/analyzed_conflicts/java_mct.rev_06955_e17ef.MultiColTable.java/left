...
import org.acme.example.view.BorderState.BorderEdge;
import org.acme.example.view.TableFormattingConstants.JVMFontFamily;

public class MultiColTable extends JPanel {
	...
	private JTable table; //is this what i want?
	private ViewSettings settings;
	
	//the following fields are not all necessarily useful:
	private JList rowHeaders; //useless?
	...
	//the following methods were orignally copy pasted somewhat blindly from labeledtable.java:
	/**
...
//			possiblyFireTableLayoutChanged();
	...
	public MultiColView getMultiColView() { return multiColView; }
}
